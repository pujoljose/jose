...
def ej1():
    ...
    '''
lista_aleatoria = [random.randint(1, 10) for x in range(3)]
suma_lista = sum(lista_aleatoria) 

if suma_lista<21:
	print("suma de numeros recolectados")
	print(suma_lista)	
else:
...
while len(repartidor_carta) != 2:
	...
	if len(repartidor_carta) == 2:
		print("repartidor tiene", repartidor_carta)
...
if sum(jugador_carta) > 21:
	print("perdiste")
elif sum(jugador_carta) == 21:
